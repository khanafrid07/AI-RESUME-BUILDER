...
export default function ClassicFormatted() {
    return (
            ...
            <div className="w-[794px] min-h-[1123px] mx-auto bg-white shadow-xl">
                ...
                <div className="grid grid-cols-3">
                    <div className="col-span-2 bg-gray-900 text-white px-10 py-12">
                        <h1 className="text-5xl font-bold">Afrid Khan</h1>
                        <p className="text-amber-400 font-semibold mt-2 text-lg">Full Stack Developer</p>
                ...
                <div className="bg-gray-100 px-10 py-4 border-b-4 border-amber-400 grid grid-cols-2 gap-4 text-sm font-medium">
                    <p className="flex items-center gap-2 text-gray-800"><Phone size={16} /> +91 9814790265</p>
                    <p className="flex items-center gap-2 text-gray-800"><Mail size={16} /> example@gmail.com</p>
                    <p className="flex items-center gap-2 text-gray-800"><MapPin size={16} /> New York, USA</p>
                </div>
                ...
                <div className="px-10 py-8 space-y-8">
                    ...
                    <section>
                        ...
                        <p className="text-sm text-gray-700 leading-7">
                            Results-driven full-stack developer with 4+ years of experience building scalable web applications. Expertise in React, Node.js, and cloud technologies. Known for delivering high-quality solutions on tight deadlines.
                        </p>
                    </section>
